...
import yaml
import mlflow
import mlflow.lightgbm  # Changed from mlflow.sklearn to mlflow.lightgbm
...
logger.setLevel(logging.DEBUG)  # Use constant for better practice
...
def main():
    mlflow.set_tracking_uri("http://ec2-15-206-147-104.ap-south-1.compute.amazonaws.com:5000")
    mlflow.set_experiment("dvc-pipeline-runs6")
    ...
    with mlflow.start_run() as run:
        try:
            ...
            mlflow.lightgbm.log_model(  # Changed to mlflow.lightgbm.log_model
                model,
                "lgbm_model",
